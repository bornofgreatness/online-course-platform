...
Choose a plan for unlimited access to enrolled courses, quizzes, and certificates while your subscription is active. Payments are processed securely with Stripe when configured.
          </p>
        </div>
